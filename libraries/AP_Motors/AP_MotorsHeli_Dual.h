...
protected:
    ...
    float get_swashplate(int8_t swash_num, int8_t swash_axis, float pitch_input, float roll_input, float yaw_input, float coll_input, float forward_input, float lateral_input, float compression_input);
